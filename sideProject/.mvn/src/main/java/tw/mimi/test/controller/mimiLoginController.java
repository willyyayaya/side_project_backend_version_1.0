...
import tw.mimi.test.repository.mimiTagRepository;
...
public class mimiLoginController {
	...
	@Autowired
	private mimiMemberRepository mimiMemberRepository;
...
//		return"message/{receiverid}";
		Long receiverid = member.getMemberid(); // 假設 receiverid 是 member ID
	    return "redirect:/message/" + receiverid; // 透過 redirect 跳轉到另一個方法
	}
}
